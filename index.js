...
const Game = {
	...
	fruitSizes: [
		{ radius: 24,  scoreValue: 1,  img: './assets/img/icon0.png'  },
		{ radius: 32,  scoreValue: 3,  img: './assets/img/icon1.png'  },
		{ radius: 40,  scoreValue: 6,  img: './assets/img/icon2.png'  },
		{ radius: 56,  scoreValue: 10, img: './assets/img/icon3.png'  },
		{ radius: 64,  scoreValue: 15, img: './assets/img/icon4.png'  },
		{ radius: 72,  scoreValue: 21, img: './assets/img/icon5.png'  },
		{ radius: 84,  scoreValue: 28, img: './assets/img/icon6.png'  },
		{ radius: 96,  scoreValue: 36, img: './assets/img/icon7.png'  },
		{ radius: 128, scoreValue: 45, img: './assets/img/icon8.png'  },
		{ radius: 160, scoreValue: 55, img: './assets/img/icon9.png'  },
		{ radius: 192, scoreValue: 66, img: './assets/img/icon10.png' },
	],
	currentFruitSize: 0,
	nextFruitSize: 0,
	setNextFruitSize: function () {
		Game.nextFruitSize = Math.floor(rand() * 5);
		Game.elements.nextFruitImg.src = `./assets/img/icon${Game.nextFruitSize}.png`;
	},
...
const menuStatics = [
	Bodies.rectangle(Game.width / 2, Game.height * 0.4, 512, 512, {
		isStatic: true,
		render: { sprite: { texture: './assets/img/aku gamau lagi buat pixel art.png' } },
	}),
